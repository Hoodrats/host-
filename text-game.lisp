...
;;first create a top evel bariable *nodes* to cotain descriptions of the location that exist in our game 
(defparameter *nodes* '((living-room (you are in the living room. A wizard is snoring loudly on the couch.))
   	     	     	(garden      (you are in a a beautifl garden.There is a  well in front of you.))
			(attic       (you are in the attic. There is a giant welding torch in the corner))))

;;create a command that describes a location(use the the assoc function)
;;(assoc 'garden *nodes*)

(defun describe-location (location nodes)
  (cdr (assoc location nodes)))
...
;;Provided security, only the allowed commands will be eval 
